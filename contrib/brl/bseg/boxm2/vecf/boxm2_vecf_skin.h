...
class boxm2_vecf_skin{
 public:
 boxm2_vecf_skin(): nbins_(25){}
 boxm2_vecf_skin(vcl_string const& geometry_file, unsigned nbins = 25);

 boxm2_vecf_skin(vgl_pointset_3d<double> const& ptset,unsigned nbins = 25): ptset_(ptset), nbins_(nbins){}

 void read_skin(vcl_istream& istr);
