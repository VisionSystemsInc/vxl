...
//:
// \file
vcl_ostream& operator << (vcl_ostream& os, boxm2_vecf_orbicularis_oris_params const& orbicularis_oris_pr)
{
  if (!os) {
...
vcl_istream& operator >> (vcl_istream& is, boxm2_vecf_orbicularis_oris_params& pr)
{
  if (!is) {
    vcl_cout << "FATAL! Bad parameter file stream\n";
    return is;
