...
void boxm2_vecf_middle_fat_pocket_scene::find_cell_neigborhoods(){
  ...
  vcl_cout << "Find middle_fat_pocket cell neighborhoods in " << static_cast<double>(t.real())/1000.0 << " sec.\n";
}
...
void boxm2_vecf_middle_fat_pocket_scene::inverse_vector_field(vcl_vector<vgl_vector_3d<double> >& vf,
...
void boxm2_vecf_middle_fat_pocket_scene::apply_vector_field_to_target(vcl_vector<vgl_vector_3d<double> > const& vf,
  ...
  vcl_cout << "Apply middle_fat_pocket vector field to " << valid_count << " out of " << n << " cells in " << t.real()/1000.0 << " sec.\n";
}
...
void boxm2_vecf_middle_fat_pocket_scene::inverse_vector_field_unrefined(vcl_vector<vgl_point_3d<double> > const& unrefined_target_pts){
...
bool boxm2_vecf_middle_fat_pocket_scene::set_params(boxm2_vecf_articulated_params const& params){
  try{
    ...
    vcl_cout<<" Can't downcast middle_fat_pocket parameters! PARAMETER ASSIGNMENT PHAILED!"<<vcl_endl;
    return false;
  }
}
