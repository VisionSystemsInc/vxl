...
class boxm2_vecf_fit_fat_pocket
{
 ...
 boxm2_vecf_fit_fat_pocket():is_right_(false){}
  ...
  boxm2_vecf_fit_fat_pocket(vcl_string const& neutral_face_ptset_path, vcl_string const& skin_layer_path, vcl_string const& fat_pocket_geo_path);
  boxm2_vecf_fit_fat_pocket(vcl_string const& neutral_face_ptset_path, vcl_string const& deformed_face_ptset_path, vcl_string const& skin_ptset_path,  vcl_string const& fat_pocket_geo_path);
  ...
  double fit_neutral(vcl_ostream* outstream=0, bool verbose=false);
  double fit_deformed(vcl_ostream* outstream=0, bool verbose=false);
...
// Data Access---------------------------------------------------------------
  ...
  bool plot_middle_fat_pocket_fit(vcl_ostream& ostr);
};
