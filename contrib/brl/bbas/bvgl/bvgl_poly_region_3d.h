...
template <class Type>
vcl_ostream&  operator<<(vcl_ostream& s, bvgl_poly_region_3d<Type> const& p);

template <class Type>
vcl_istream&  operator>>(vcl_istream& is,  bvgl_poly_region_3d<Type>& p);

#define BVGL_POLY_REGION_3D(T) extern "please include bbas/bvgl/bvgl_poly_region_3d.txx first"
