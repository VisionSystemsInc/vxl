...
class bvgl_grid_index_3d{
 ...
 bvgl_grid_index_3d(): has_scalars_(false),has_normals_(false),
  ...
  bvgl_grid_index_3d(unsigned nx, unsigned ny, unsigned nz, vgl_pointset_3d<double> ptset, std::vector<double> scalars, double thresh = 1.0);
 ...
 protected:
  ...
  vbl_array_3d<std::vector<double> >  s_grid_;//optional scalar
